...
def releaseBalls():
    changeVerticalSteppersSpeed(500) #original: 360 Testing faster release
...
def slowMoveDownToDrop():
    changeVerticalSteppersSpeed(5)
    leftVerticalStepper.startRelativeMove(-35)
    ...
    changeVerticalSteppersSpeed(360)
    releaseBalls()
...
def pickUpOneBall():
    ...
    leftHorizontalStepper.startGoToPosition(distLeft - 5)
    #rightHorizontalStepper.startGoToPosition(distRight - 5)

    while(checkHorizontalSteppersIfBusy()):
        continue

    #Change vertical steppers speed and raise the scoopers
    changeVerticalSteppersSpeed(liftSpeed)
    leftVerticalStepper.startRelativeMove(distUp)
    #rightVerticalStepper.startRelativeMove(distUp)
    ...
    leftHorizontalStepper.startRelativeMove(-1 * distBack + 50) #testing distance pulled back to drop
